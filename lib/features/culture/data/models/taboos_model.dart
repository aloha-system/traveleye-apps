...
class TaboosModel extends Taboos {
  ...
  factory TaboosModel.fromJson(Map<String, dynamic> json) =>
      TaboosModel(food: json["food"], publicDisplay: json["public_display"]);
  ...
  Taboos toEntity() =>
      Taboos(food: food, publicDisplay: publicDisplay);
}
